      ...
      <el-form label-width="0" style="margin-top: 8px">
        ...
        <el-form-item v-for="cfg in activeVolcConfigs" :key="cfg.service_type" :label="{text:'文本/对话',image:'文本生成图片',storyboard_image:'分镜图片生成',video:'视频生成'}[cfg.service_type]" label-width="120px">
          <el-select v-model="volcSelected[cfg.service_type]" filterable allow-create placeholder="选择或输入完整 Model ID" style="width:100%">
            ...
            <el-option-group label="其他模型（请核对用途）">
              <el-option v-for="id in volcModels.filter(id=>!modelCandidates(volcModels,cfg.service_type).includes(id))" :key="id" :label="id" :value="id" />
            </el-option-group>
          </el-select>
        </el-form-item>
      </el-form>
...
const providerConfigs = {
  text: [
    ...
    { id: 'volcengine', name: '火山引擎', models: ['deepseek-v4-flash-260425', 'deepseek-v3-2-251201', 'doubao-1-5-pro-32k-250115', 'kimi-k2-thinking-251104'] },
...
const VOLCENGINE_CONFIGS = [
  { service_type: 'text', name: '火山引擎 DeepSeek V4 Flash 文本', base_url: 'https://ark.cn-beijing.volces.com/api/v3', provider: 'volcengine', model: ['deepseek-v4-flash-260425'] },
  { service_type: 'image', name: '火山引擎 即梦 文本生图', base_url: 'https://ark.cn-beijing.volces.com/api/v3', provider: 'volcengine', model: ['doubao-seedream-4.5'] },
  { service_type: 'storyboard_image', name: '火山引擎 即梦 分镜图', base_url: 'https://ark.cn-beijing.volces.com/api/v3', provider: 'volcengine', model: ['doubao-seedream-4.5'] },
  { service_type: 'video', name: '火山引擎 即梦 视频', base_url: 'https://ark.cn-beijing.volces.com/api/v3', provider: 'volces', model: ['Doubao-Seedance-1.5-pro'] }
]
